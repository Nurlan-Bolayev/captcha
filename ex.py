...
def captcha_form_s() :
    ...
    class CheckCap :
        ...
        def post_ (self) :
            ...
            r = requests.post(url = 'https://captcha-api-qfegkg7fda-ew.a.run.app/api/v1/captchas/add',  headers={"Content-Type" : "application/json" , "Token" : "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdXRob3JpemVkIjp0cnVlLCJleHAiOjE2NDE1NzUzMzIsInVzZXJfaWQiOiI2MWQ1NDAyYTZjOWZkYWRkZDQ5Mzg3MGUifQ.HL7ZtgAOnZi30sjhMNyFCv8fLAictCBiwAgvRtg0n9Q"}, json={"base64" : "TEpXNDJF" , "captcha" : "LJW42E"}) 
    ...
    class CheckCap :
        ...
        def get_ (self, captcha_id = None ) :
            ...
            if not captcha_id :
                ...
                self.to_print_get_ = json_data
                self.get_request_.update(json_data)
                d = 'Null' if not json_data['answer'] else json_data['answer']
